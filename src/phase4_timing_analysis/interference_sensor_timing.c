...
K_THREAD_STACK_DEFINE(busy_stack, STACK_SIZE);

struct k_thread sensor_thread_data;
struct k_thread busy_thread_data;
...
void busy_thread(void *arg1, void *arg2, void *arg3)
{
    ARG_UNUSED(arg1);
    ARG_UNUSED(arg2);
    ARG_UNUSED(arg3);
...
int main(void)
{
    ...
    printk("Phase 4C: Scheduler timing under interference starting\n");
    ...
    k_thread_create(&busy_thread_data, busy_stack, STACK_SIZE,
                    busy_thread,
                    NULL, NULL, NULL,
                    BUSY_PRIORITY, 0, K_NO_WAIT);
